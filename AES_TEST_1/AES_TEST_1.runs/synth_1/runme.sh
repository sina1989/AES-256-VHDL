...
HD_PWD='C:/Users/OmerFarukPC/Desktop/Ders/vivado_projects/AES_TEST_1/AES_TEST_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Encryption_IO_Wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Encryption_IO_Wrapper.tcl

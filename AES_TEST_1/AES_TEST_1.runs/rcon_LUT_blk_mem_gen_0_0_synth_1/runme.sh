...
HD_PWD='C:/Users/OmerFarukPC/Desktop/Ders/vivado_projects/AES_TEST_1/AES_TEST_1.runs/rcon_LUT_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rcon_LUT_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rcon_LUT_blk_mem_gen_0_0.tcl

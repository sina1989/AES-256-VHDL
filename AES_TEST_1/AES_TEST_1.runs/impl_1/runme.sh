...
HD_PWD='C:/Users/OmerFarukPC/Desktop/Ders/vivado_projects/AES_TEST_1/AES_TEST_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Encryption_IO_Wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Encryption_IO_Wrapper.tcl -notrace

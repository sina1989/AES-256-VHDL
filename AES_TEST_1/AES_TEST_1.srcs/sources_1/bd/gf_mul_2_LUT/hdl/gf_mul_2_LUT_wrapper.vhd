...
--Date        : Tue Apr 24 23:50:51 2018
--Host        : OmerFaruk-PC running 64-bit major release  (build 9200)
--Command     : generate_target gf_mul_2_LUT_wrapper.bd
--Design      : gf_mul_2_LUT_wrapper
...
entity gf_mul_2_LUT_wrapper is
  port (
...
end gf_mul_2_LUT_wrapper;

architecture STRUCTURE of gf_mul_2_LUT_wrapper is
  component gf_mul_2_LUT is
  port (
    gf_mul_2_port_addr : in STD_LOGIC_VECTOR ( 7 downto 0 );
    gf_mul_2_port_clk : in STD_LOGIC;
    gf_mul_2_port_dout : out STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  end component gf_mul_2_LUT;
begin
gf_mul_2_LUT_i: component gf_mul_2_LUT
     port map (
      gf_mul_2_port_addr(7 downto 0) => gf_mul_2_port_addr(7 downto 0),
      gf_mul_2_port_clk => gf_mul_2_port_clk,

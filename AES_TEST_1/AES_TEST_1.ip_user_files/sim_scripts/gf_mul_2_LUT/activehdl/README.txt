...
#
# Generated by export_simulation on Tue Apr 24 23:09:16 +0300 2018
#
################################################################################
...
'-reset_run' switch to the './gf_mul_2_LUT.sh' script.

./gf_mul_2_LUT.sh -reset_run
...
./gf_mul_2_LUT.sh -noclean_files

For more information on the script, please type './gf_mul_2_LUT.sh -help'.
